...
| Event schema/versioning tooling | Implementation/tooling gap | Event Envelope / Schema | Formal tooling and serialization details are open. | Envelope atom moves from conceptual contract to implementation schema. |
