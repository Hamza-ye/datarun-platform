...
- `../pre-operations/README.md`: readiness assessment, accepted pre-spec-drafting decision record, and decision-board entrypoint for reviewing high-impact choices before affected platform-spec work.
- `../product-alignment/README.md`: product/UX alignment track for reconnecting Phase 1 scenarios, workflows, user expectations, and the accepted architecture baseline before broad platform-spec work.
