...
- **Outputs**: command-capability decisions used by the production `/web-admin` shell gate and `/web-admin/config` handlers. Missing, malformed, or unknown-command policy fails closed for command evaluation.
