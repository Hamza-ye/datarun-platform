...
> **Historical addendum (2026-04-21)**: [Envelope Type Mapping for Identity and Integrity Events](adr-002-addendum-type-vocabulary.md) was superseded by ADR-007. For ADR-001 through ADR-005 baseline purposes, ADR-004 S3 is the authoritative six-type envelope closure; do not treat the addendum body as current baseline authority.
