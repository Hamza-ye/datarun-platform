...
> **Historical related addendum (2026-04-21)**: [ADR-002 Addendum — Envelope Type Mapping](adr-002-addendum-type-vocabulary.md) was superseded by ADR-007. ADR-004 S3 remains the ADR-001 through ADR-005 authority for the six-type envelope vocabulary; do not treat the addendum body as current baseline authority.
