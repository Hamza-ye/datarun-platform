...
> **LEGACY AGENT NOTES.**
> Do not use this file as authority for platform-spec atomization or section drafting.
> Current baseline assessment starts at
...
- When in doubt during future controlled specification work, read
  ...
  before accepting specification language.
...
For baseline assessment, the owning surface is
...
- **Rule R-1 (no silent deferral)**: Add or update a professional-baseline gap/control entry before accepting a baseline claim. "I'll remember" is not a mechanism.
