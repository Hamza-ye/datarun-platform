...
**Last updated**: 2026-05-23 (Phase 4.3 domain uniqueness landed)
...
**Phase 4: Workflow & Policies** — active implementation. IDR-020, IDR-021, IDR-022, IDR-023, and IDR-024 are drafted/active; the Phase 4 implementation spec is drafted, and Phase 4.1 role-action, Phase 4.2 flag severity, and Phase 4.3 domain uniqueness have landed.
