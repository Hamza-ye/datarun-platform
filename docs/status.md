...
**Last updated**: 2026-05-24 (FP-009 runtime resolver enforcement landed; FP-011 auth-provider mapping tracked)
...
**Phase 4: Workflow & Policies** — active implementation. IDR-020, IDR-021, IDR-022, IDR-023, IDR-024, IDR-025, and IDR-026 are active; the Phase 4 implementation spec is drafted, and Phase 4.1 role-action, Phase 4.2 flag severity, and Phase 4.3 domain uniqueness have landed.
