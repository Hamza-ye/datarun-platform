...
**Last updated**: 2026-06-04 (NW-038 OIDC/JWKS auth-provider boundary accepted; FP-011/BAR-104 remain open)
...
- Recommended next slice: NW-039 production principal-binding administration path decision. Keep it focused on how `(issuer, subject) -> actor_id` bindings are created, rotated, deactivated, audited, and bootstrapped; do not add group/claim authority, new scope mechanisms, resolver reassignment, auto-resolution, or envelope changes.
