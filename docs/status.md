...
**Phase 4: Workflow & Policies** — complete. IDR-020, IDR-021, IDR-022, IDR-023, IDR-024, IDR-025, and IDR-026 are active; the Phase 4 implementation spec is reconciled, and Phase 4.1 role-action, Phase 4.2 flag severity, Phase 4.3 domain uniqueness, Phase 4.4 pattern registry/binding validation, Phase 4.5 pattern-state projection, Phase 4.6 transition detection, FP-005 subject-history backfill, FP-009 resolver enforcement, and P04 scenario-grade Responsibility Binding coverage have landed.
