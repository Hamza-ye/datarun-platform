...
**Last updated**: 2026-05-22 (IDR-024 assignment containment decision drafted)
...
| FP-007 | Multi-axis assignment containment and null-activity semantics | Phase 4 assignment-administration hardening | A | **OPEN** |
...
**Phase 4: Workflow & Policies** — active implementation. IDR-020, IDR-021, IDR-022, IDR-023, and IDR-024 are drafted/active; the Phase 4 implementation spec is drafted, and Phase 4.1 role-action plus Phase 4.2 flag severity have landed.
...
- IDR-024 (Multi-axis Assignment Containment) is drafted. It closes the decision gap around assignment creation/end containment across `geographic`, `subject_list`, and `activity`, defines explicit bootstrap/root semantics, and states that activity-restricted assignments do not authorize ordinary null-activity work events.
...
- Recommended next implementation slice: assignment administration hardening from IDR-024, followed by Phase 4.3 domain uniqueness schema, detector, and mobile advisory uniqueness from IDR-022.
