...
- Classification answers what kind of gap this is; progress metadata answers what would move or stale the gap.
- Progress metadata is required only when a gap is open, blocked, future-decision, partially accepted, or selection-relevant.
- Closed/current-baseline gap rows do not need progress metadata unless they retain a successor route.

## Known Gap Register

last-reviewed: 2026-06-21

review-note: NW-072 materially touched GAP-CONFLICT-01 through GAP-CONFLICT-03 by accepting the PC2-scoped conflict/flag current-behavior reference and operational attention query boundary; future routing should build from that accepted reference instead of reselecting NW-072.
...
| GAP-CONFLICT-01 | Flag queue ergonomics | Bounded PC2 one-item read/review UI accepted; future queue ergonomics unselected | Platform-spec detail gap / implementation tooling gap | NW-072 accepted the PC2-scoped current flag behavior and operational attention query boundary. NW-122 accepted the bounded single work-linked one-item attention read/review UI. Remaining open work is future queue or multi-item ergonomics only if separately selected; this does not imply list, batch, automation, resolver reassignment, or broad conflict console behavior. |
| GAP-CONFLICT-02 | Domain conflict automation and batch resolution | Future decision; PC2 current flag semantics reference accepted | Architecture decision gap / platform-spec detail gap | Use accepted NW-072 as the PC2-scoped current-behavior reference for flag semantics. Automation and batch conflict resolution remain parked under NW-045 or a later explicit route; NW-072 did not solve or select automation. |
| GAP-CONFLICT-03 | Resolver-steward eligibility policy | Specific flagged-item resolver equality accepted; general eligibility fallback still open | Platform-spec detail gap; architecture decision gap if a new resolver capability or authority primitive is introduced | NW-072 accepted exact stored `designated_resolver` equality as product-safe for a specific flagged item. Resolver fallback remains not product-safe as a general authority promise; product or production work that needs explicit resolver eligibility requires a successor eligibility decision. |
...
## Gap Progress Metadata

This metadata is routing state, not a new taxonomy. Keep the five gap
classifications unchanged.

| Gap ID | Evidence gate | Selection trigger | Blocked by | Next executable action | Stale when | Owning NW | Durable successor |
|---|---|---|---|---|---|---|---|
| GAP-OPS-01 | Real-production approval evidence, not more synthetic rehearsal. | Concrete real users/data, provider, region, jurisdiction, or support commitment. | NW-093 trigger. | Select NW-093 when the trigger appears. | Real-production approval is accepted or the operational approval route changes. | NW-093 | Operations policy/runbook/rehearsal records. |
| GAP-PRODUCT-01 | Concrete pressure for managed control plane or tenant-aware runtime. | Multi-customer managed deployment, SaaS control plane, tenant selection, or pooled runtime pressure. | none | Select NW-094 through NW-098 as applicable. | Product Candidate 1 routing changes or tenant-aware decisions are accepted. | NW-094 through NW-098 | Product spec, platform specs, contracts, or operations docs as selected. |
| GAP-RETENTION-01 | Security/platform evidence for local expiry or retained-data behavior. | Expiry, decommissioning, sealed recovery, local encryption, token/session retention, no-local-retention, erasure, redaction, or sensitivity claims. | security/platform decision. | Select NW-054. | Retention/security policy is accepted or server event-history semantics are re-routed. | NW-054 | Platform spec or operations policy. |
| GAP-RETENTION-02 | Worker exit/offboarding policy evidence. | Offboarding, exit procedure, shared-device handoff, or access-removal pressure. | security/platform decision. | Select NW-054 or a bounded successor row. | Offboarding policy is accepted or folded into a broader retention/security spec. | NW-054 | Operations policy or platform spec. |
| GAP-RETENTION-03 | Regulatory/security evidence for encryption, redaction, erasure, or sensitivity. | Compliance, sensitivity, encryption, redaction, erasure, or no-local-retention pressure. | security/platform decision. | Select NW-054 or a formal successor decision. | Regulatory/security policy is accepted or server immutability authority changes. | NW-054 | Platform/security spec or operations policy. |
| GAP-AUTH-02 | Product/platform evidence for actor-as-subject delivery. | Subject/query/custom scope pressure that cannot be represented by accepted assignments. | product/platform decision. | Select NW-053. | Subject/query/custom scope boundary is accepted or rejected. | NW-053 | Platform spec or architecture decision route. |
| GAP-AUTH-04 | Evidence for cross-activity cohort materialization. | Cohort, cross-activity, subject-query, or custom-scope work becomes active. | product/platform decision. | Select NW-053. | A cohort/scope decision is accepted or pressure is withdrawn. | NW-053 | Platform spec or architecture decision route. |
| GAP-AUTH-05 | Evidence for second-actor cross-activity subject access. | A concrete second-actor access case cannot use accepted assignment axes. | product/platform decision. | Select NW-053. | Cross-activity subject access is accepted, rejected, or folded into another scope route. | NW-053 | Platform spec or architecture decision route. |
| GAP-PROJECTION-01 | Product/reporting evidence for aggregate access semantics. | Reporting, aggregate, broad read API, warehouse, import/export, or drilldown work becomes active. | product/platform decision. | Select NW-044 or a bounded reporting spec row. | Aggregate visibility rules are accepted or the reporting route changes. | NW-044 | Product/platform spec or contracts if wire behavior changes. |
| GAP-PROJECTION-02 | Product/reporting evidence for freshness and completeness semantics. | Reporting freshness, unresolved-flag handling, completeness, or drilldown pressure. | product/platform decision. | Select NW-044 or a bounded reporting spec row. | Reporting freshness semantics are accepted or deferred explicitly. | NW-044 | Product/platform spec. |
| GAP-CONFLICT-01 | Accepted NW-072 platform spec plus accepted NW-122 bounded one-item PC2 read/review UI evidence. | Queue, list, or multi-item attention ergonomics becomes selected. | none | Select a bounded queue/multi-item ergonomics row only if that product work is explicitly chosen; do not create batch, automation, resolver reassignment, or broad console scope. | Future queue/multi-item ergonomics is accepted, rejected, or withdrawn. | NW-072 accepted reference; NW-122 accepted bounded UI | Platform spec plus implementation evidence if selected. |
| GAP-CONFLICT-02 | Product/platform evidence for automation or batch resolution beyond accepted PC2 current flag semantics. | Batch resolution, auto-resolution, conflict automation, or resolver reassignment pressure. | platform decision. | Use accepted NW-072 for current flag semantics; select NW-045 only if automation, batch, or reassignment pressure appears. | Automation/batch policy is accepted or rejected. | NW-045 | Architecture decision route or platform spec. |
| GAP-CONFLICT-03 | Evidence for explicit resolver-steward eligibility beyond exact stored resolver equality on a flagged item. | Conflict/admin UX or production hardening depends on resolver eligibility beyond current fallback. | platform/product decision. | Use accepted NW-072 for exact `designated_resolver` equality on a flagged item; select a successor eligibility decision if product or production work needs explicit eligibility beyond resolver fallback. | Resolver eligibility policy is accepted or fallback is removed from product path. | NW-072 accepted reference; successor not selected | Platform spec or architecture decision route. |
| GAP-WORKFLOW-01 | Pattern inventory evidence beyond accepted canonical contract/delivery. | Pattern traversal/reporting, inventory expansion, projection change, or pattern API/product work. | none | Select NW-073 before dependent work. | Pattern registry/projection durable behavior is accepted. | NW-073 | Platform spec and contracts. |
| GAP-WORKFLOW-02 | Compatibility evidence for pattern migration mechanics. | Concrete pattern compatibility or migration pressure appears. | none | Create/select a bounded migration row when pressure appears. | Migration policy is accepted or compatibility pressure is withdrawn. | not selected | Platform spec or implementation design. |
| GAP-WORKFLOW-04 | Policy evidence for additional auto-resolution behavior. | Additional auto-resolution policy becomes product/platform work. | platform decision. | Select NW-045. | Auto-resolution policy is accepted or rejected. | NW-045 | Architecture decision route or platform spec. |
| GAP-WORKFLOW-05 | Validator evidence for participant vocabulary or deployer mapping. | Pattern-validator cleanup or participant vocabulary change becomes active. | none | Select NW-073 if current pattern behavior must become normative; otherwise create a bounded implementation row. | Validator alignment lands or vocabulary semantics are accepted. | NW-073 or not selected | Platform spec, contracts, or implementation evidence. |
| GAP-CONFIG-01 | Tooling evidence for syntax evolution that preserves contracts. | Config authoring syntax/tooling format work becomes active. | none | Create/select a bounded implementation/tooling row. | Syntax/tooling route is accepted or folded into config polish. | not selected | Implementation evidence or platform spec if semantics change. |
| GAP-CONFIG-02 | Evidence for setup polish beyond accepted NW-088 workflow. | Structured editor, candidate ergonomics, or setup lifecycle semantic change. | none | Create/select a bounded config polish row; use a spec/policy route if semantics change. | Richer setup polish is accepted or lifecycle semantics change. | not selected | Implementation evidence, platform spec, or operations policy. |
| GAP-CONFIG-03 | Validation evidence for complexity-budget change. | Complexity guardrails must change for concrete product/platform pressure. | none | Create/select a bounded platform-spec row; use architecture review if guardrails weaken. | Complexity-budget change is accepted or explicitly rejected. | not selected | Platform spec or architecture decision route. |
| GAP-SYNC-01 | Product/platform evidence for handoff contents. | Handoff package, subject-history transfer, sync handoff, or actor-partition pressure. | none | Create/select a bounded handoff spec row. | Handoff contents are specified or folded into retention/scope work. | not selected | Platform spec. |
| GAP-SCENARIO-01 | Product/spec evidence that scenario probes require follow-through. | Product/spec work cites S00/S19/S21/S22/S23/S26/S27 as current evidence. | none | Select/create the bounded product or platform spec row that consumes the probe. | Scenario evidence is consumed into durable specs or new primitive pressure appears. | not selected | Product/platform specs or backlog successor rows. |
