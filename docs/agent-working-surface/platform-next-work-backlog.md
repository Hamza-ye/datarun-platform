...
| NW-023 | Create scenario-to-baseline pressure map | scenario_review | P1 | `ready` | `docs/reviews/scenario-baseline-pressure-map-protocol.md`; scenarios index; BAR | NW-003, NW-011 | Scenarios are triaged against BAR/deferred surfaces and 2-4 near-term runtime probes are recommended without promoting deferred work. |
