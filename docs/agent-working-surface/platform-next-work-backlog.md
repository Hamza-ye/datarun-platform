...
| NW-010 | Verify mobile baseline | baseline_acceptance | P1 | `blocked` | BAR-008, BAR-011, BAR-012, BAR-014 | NW-024 | Targeted Flutter tests for config, expression, projection, pattern, selective retention, and mobile advisory authority boundary pass. |
...
| NW-024 | Fix mobile advisory authority boundary | baseline_fix | P1 | `ready` | CDL-003, CDL-035, CDL-047; NW-010 stop report | NW-010 stop condition | Mobile role/action/workflow advisories warn without becoming authoritative rejection of structurally valid capture; focused regressions and NW-010 targeted mobile suite pass. |
