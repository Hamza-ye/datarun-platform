...
| NW-007 | Verify flag catalog and resolver routing | baseline_acceptance | P0 | `ready` | BAR-006 | NW-003 | Targeted flag/resolution tests prove exact resolver equality and resolver payload presence. |
