...
| NW-027 | Verify BAR-002 append-only event store acceptance | baseline_acceptance | P1 | `ready` | BAR-002; CDL-001, CDL-002, CDL-019, CDL-021; NW-026 runtime evidence | NW-026 | Code inspection proves no operational event update/delete path beyond documented insert-time denormalization, sync tests prove idempotent inserts, and BAR-002 is either accepted with evidence or left candidate with exact drift. |
| NW-028 | Verify BAR-015 historical location-path immutability | baseline_acceptance | P1 | `ready` | BAR-015; CDL-031, CDL-033; IDR-014/015 | NW-027 | Code inspection and targeted evidence prove historical `events.location_path` is not rewritten after insert except controlled NULL backfill; add a regression only if a reparent/backfill surface exists, then accept BAR-015 or report drift. |
