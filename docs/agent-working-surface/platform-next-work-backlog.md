...
| NW-031 | Verify BAR-010 config package delivery baseline | baseline_acceptance | P1 | `ready` | BAR-010; CDL-038, CDL-039, CDL-041, CDL-044, CDL-056 | NW-010, NW-030 | Prove deploy-time validation, package atomicity, shape version coexistence, referenced pattern definition delivery, mobile two-slot/pending config behavior, and safe unknown-key behavior; if evidence holds, accept BAR-010 and mark this row accepted. |
