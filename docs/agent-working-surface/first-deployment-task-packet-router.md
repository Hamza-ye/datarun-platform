...
| FD-PKT-004 | Pending FD-PKT-003 review. | Define mobile/offline validation only after product/spec and evidence gates exist. |
| FD-PKT-005 | Pending FD-PKT-003 review. | Assess view-model/contract need without creating new contracts unless routed. |
...
4. Draft FD-PKT-004 and FD-PKT-005 narrowly: mobile/offline evidence and
