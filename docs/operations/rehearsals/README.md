...
| [2026-06-28 NW-181 local deployment image refresh and field-assets smoke](2026-06-28-nw181-local-deployment-image-refresh-and-field-assets-smoke.md) | Record | `blocked`; image refresh passed, field-assets seed precondition failed | [Reference deployment](../runbooks/production-deployment-runbook.md) | NW-181 | 2026-06-28 |
